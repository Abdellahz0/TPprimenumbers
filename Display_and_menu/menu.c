...
{ // the menu where the user manipulates the differente questions in the TP
    ...
    do
    {
        ...
        do
        {
            ...
            for (i = 1; i <= max_choice; i++)
            {
                if (i == choice)
                {
                    ...
                    if (choice <= 2 || choice == 6 || (choice == 3 && decision) || (choice == 4 && decision1) || (choice == 5 && decision2))
                    {
                        printf("#\033[34m --> ");
                    }
                    else
        ...
        case 4:
            ...
            {
                if (!decision)
                { // if Q2 and Q3 are both not executed
                    printf("You have to create the linked list first in question 2 dynamic implementation\n");
                    printf("then index it in Q3\n");
                }
                else
                { // if Q2 was executed but Q3 is not
        ...
        case 5:
            ...
            break;
        case 6:
            printf("Enter the upper bound to compare number of iterations in each structure : ");
            scanf("%d", &n);
            iter1 = 0;
            iter2 = 0;
            iter3 = 0;
            ...
            create_prime_list(n - 1, &head2);
            check_prime(head2, &iter2);
            free_list(head2);
